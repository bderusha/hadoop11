...
public class Tokenizer {
    ...
    public List<String> tokenize(String sentenceStr) {
        ...
        LinkedList<String> lemmas = new LinkedList<String>(sentenceSent.lemmas());
        // Remove stopwords
        lemmas.removeAll(STOPWORD_SET);
